...
open class AdornReiClient : REIClientPlugin {
    ...
    override fun registerDisplays(registry: DisplayRegistry) {
        registry.registerRecipeFiller(ItemBrewingRecipe::class.java, AdornRecipes.BREWING_TYPE.get()) { BrewerDisplay(it.value) }
        registry.registerRecipeFiller(FluidBrewingRecipe::class.java, AdornRecipes.BREWING_TYPE.get()) { BrewerDisplay(it.value) }
    }
